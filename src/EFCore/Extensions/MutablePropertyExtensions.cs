...
namespace Microsoft.EntityFrameworkCore
{
    ...
    public static class MutablePropertyExtensions
    {
        ...
        /// <summary>
        ///     Sets the custom <see cref="ValueComparer" /> for keys for this property when performing key comparisons.
        /// </summary>
        /// <param name="property"> The property. </param>
        /// <param name="comparer"> The comparer, or <c>null</c> to remove any previously set comparer. </param>
        ...
        /// <summary>
        ///     Sets the custom <see cref="ValueComparer" /> for deep copies for this property when performing key comparisons.
        /// </summary>
        /// <param name="property"> The property. </param>
        /// <param name="comparer"> The comparer, or <c>null</c> to remove any previously set comparer. </param>
